...
export type MessagePayload<T extends MessageType> = Extract<GameMessage, { type: T }>;
...
export interface WebRTCConnection {
  ...
  sendAndWaitForResponse<T extends MessageType>(message: GameMessage, responseType: T): Promise<MessagePayload<T>>;
}
